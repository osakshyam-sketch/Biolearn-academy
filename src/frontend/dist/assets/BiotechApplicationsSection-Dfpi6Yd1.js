import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as motion, A as AnimatePresence } from "./index-V1Xys_hZ.js";
...
const CATEGORIES = [
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Syringe_icon.svg/240px-Syringe_icon.svg.png",
    imageAlt: "Medical syringe representing biotechnology medicine applications",
    accentOklch: "0.70 0.20 350",
    examples: [
      {
        title: "Recombinant Insulin",
        detail: "The first recombinant protein approved for human use (1982). Human insulin gene was cloned into E. coli, enabling cheap, scalable production for millions of diabetics worldwide — replacing animal-derived insulin."
      },
      {
        title: "Monoclonal Antibodies",
        detail: "Engineered antibodies (e.g., trastuzumab for HER2+ breast cancer, adalimumab for rheumatoid arthritis) that bind a single specific antigen with high affinity. Produced in CHO cell bioreactors."
      },
      {
        title: "Recombinant Vaccines",
        detail: "Hepatitis B vaccine uses a recombinant yeast-produced antigen, eliminating safety risks of blood-derived vaccines. mRNA vaccines (COVID-19) use lipid nanoparticles to deliver mRNA encoding viral proteins."
      },
      {
        title: "Gene Therapy",
        detail: "Delivering functional gene copies to correct genetic disorders. Approved therapies include Zolgensma (SMA) and Luxturna (inherited retinal dystrophy), using viral vectors to restore missing function."
      }
    ]
  },
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/24701-nature-natural-beauty.jpg/320px-24701-nature-natural-beauty.jpg",
    imageAlt: "Green crop field representing agricultural biotechnology",
    accentOklch: "0.72 0.18 142",
    examples: [
      {
        title: "Bt Crops",
        detail: "Bacillus thuringiensis (Bt) toxin genes introduced into corn, cotton, and soy confer insect resistance, reducing pesticide use by up to 40% while increasing yield in pest-prone regions."
      },
      {
        title: "Herbicide-Tolerant Crops",
        detail: "Crops engineered to withstand broad-spectrum herbicides (e.g., glyphosate-tolerant soy) allow more efficient weed control, enabling no-till farming that reduces soil erosion."
      },
      {
        title: "Golden Rice",
        detail: "Engineered with β-carotene biosynthesis genes to address Vitamin A deficiency, which causes ~500,000 cases of childhood blindness per year in developing countries."
      },
      {
        title: "Disease-Resistant Varieties",
        detail: "GM papayas (ringspot virus-resistant) saved Hawaii's papaya industry in the 1990s. CRISPR-edited wheat with reduced gluten sensitivity is under development."
      }
    ]
  },
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Enzymes_lock_and_key.svg/320px-Enzymes_lock_and_key.svg.png",
    imageAlt: "Enzyme lock and key diagram representing industrial biotechnology",
    accentOklch: "0.70 0.18 210",
    examples: [
      {
        title: "Biofuels",
        detail: "Engineered microorganisms (yeast, algae, bacteria) ferment agricultural waste and biomass into bioethanol and biodiesel. Cellulosic ethanol uses fungal cellulases to break down plant cell walls."
      },
      {
        title: "Industrial Enzymes",
        detail: "Recombinant enzymes in laundry detergents (proteases, lipases, amylases) work at low temperatures, saving energy. Over 500 industrial enzymes are produced via microbial fermentation."
      },
      {
        title: "Bioplastics",
        detail: "Polyhydroxyalkanoates (PHAs) produced by engineered bacteria offer biodegradable alternatives to petroleum-based plastics, breaking down in soil within months vs. hundreds of years."
      },
      {
        title: "Mining & Materials",
        detail: "Bioleaching uses Acidithiobacillus bacteria to extract copper, gold, and uranium from low-grade ores — an eco-friendlier alternative to smelting, now recovering ~15% of global copper."
      }
    ]
  },
  {
    ...
    imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/The_Earth_seen_from_Apollo_17.jpg/240px-The_Earth_seen_from_Apollo_17.jpg",
    imageAlt: "Earth from space representing environmental biotechnology",
    accentOklch: "0.72 0.18 172",
    examples: [
      {
        title: "Bioremediation",
        detail: "Microorganisms degrade pollutants in contaminated soil and water. Pseudomonas and Rhodococcus species break down petroleum hydrocarbons; Geobacter reduces uranium to insoluble forms, containing radioactive contamination."
      },
      {
        title: "Wastewater Treatment",
        detail: "Activated sludge bioreactors use microbial communities to remove organic waste, nitrogen, and phosphorus from sewage. Engineered biofilms now achieve >99% removal of key pollutants."
      },
      {
        title: "Biosensors for Monitoring",
        detail: "Genetically engineered whole-cell biosensors (bacteria expressing reporter genes) detect heavy metals, pesticides, and toxins in water and soil at nanomolar concentrations."
      },
      {
        title: "Plastic-Degrading Enzymes",
        detail: "PETase enzyme (discovered in Ideonella sakaiensis) and engineered FAST-PETase variant break down PET plastics at room temperature, offering a biological recycling route for plastic waste."
      }
    ]
  }
];
function AppCard({ category, isExpanded, onToggle, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        ...
        boxShadow: isExpanded ? `0 0 28px oklch(${accent} / 0.18)` : `0 0 12px oklch(${GREEN} / 0.06)`,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", role: "img", "aria-hidden": "true", children: category.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h3",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-snug", children: category.tagline })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
          ...
          motion.section,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4", children: category.examples.map((ex, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  motion.div,
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: ex.detail })
                    ]
                  },
                  ex.title
                )) })
...
const BIOTECH_APP_QUIZ = [
  {
    id: "bta1",
    topic: "biotech-applications",
    question: "Recombinant human insulin, the first biotech drug approved for human use, was produced using which host organism?",
    options: [
    ...
    correctIndex: 2,
    explanation: "The first recombinant insulin (Humulin, 1982) was produced in Escherichia coli by inserting the human insulin gene. This was a landmark in biotechnology, replacing animal-derived insulin and making production far more scalable."
  },
  {
    id: "bta2",
    topic: "biotech-applications",
    question: "What is the primary purpose of a monoclonal antibody in medicine?",
    options: [
    ...
    correctIndex: 1,
    explanation: "Monoclonal antibodies are engineered to bind one specific antigen target. This precision enables their use as cancer therapies (e.g., trastuzumab targeting HER2), autoimmune treatments, and diagnostics."
  },
  {
    id: "bta3",
    topic: "biotech-applications",
    question: "GM crops expressing Bt toxin genes primarily provide what benefit?",
    options: [
    ...
    correctIndex: 2,
    explanation: "Bt (Bacillus thuringiensis) toxin genes confer insect resistance — crops like Bt corn and Bt cotton produce proteins that are toxic to specific insect pests, reducing the need for chemical pesticides by up to 40%."
  },
  {
    id: "bta4",
    topic: "biotech-applications",
    question: "Golden Rice was engineered to address which specific nutritional deficiency in developing countries?",
    options: [
    ...
    correctIndex: 2,
    explanation: "Golden Rice was engineered to produce β-carotene (a Vitamin A precursor) to address Vitamin A deficiency, which causes up to 500,000 cases of childhood blindness per year in regions that depend heavily on rice."
  },
  {
    id: "bta5",
    topic: "biotech-applications",
    ...
    correctIndex: 1,
    explanation: "Bioremediation uses naturally occurring or engineered microorganisms to break down or neutralize pollutants such as petroleum hydrocarbons, heavy metals, and industrial chemicals in contaminated soil and water."
  },
  {
    id: "bta6",
    topic: "biotech-applications",
    ...
    correctIndex: 1,
    explanation: "Gene therapy delivers functional gene copies (often via viral vectors) to cells with missing or defective genes. Approved therapies like Zolgensma (SMA) and Luxturna (retinal dystrophy) have shown dramatic therapeutic benefits."
  },
  {
    id: "bta7",
    topic: "biotech-applications",
    question: "Which microorganism is most commonly used in cellulosic biofuel production?",
    options: [
    ...
    correctIndex: 1,
    explanation: "Cellulosic biofuel production requires cellulase enzymes to break down cellulose in plant biomass. Trichoderma reesei and related fungi are major producers of commercial cellulases used in second-generation biofuel processes."
  },
  {
    id: "bta8",
    topic: "biotech-applications",
    question: "Polyhydroxyalkanoates (PHAs) are biotechnology products important for which application?",
    options: [
    ...
    correctIndex: 1,
    explanation: "PHAs are biodegradable polyesters produced by engineered bacteria. They serve as sustainable alternatives to petroleum-based plastics, decomposing in soil within months rather than centuries."
  },
  {
    id: "bta9",
    topic: "biotech-applications",
    question: "Which technology uses biological agents to extract metals from low-grade ores?",
    options: [
      "Biomagnification",
      "Bioleaching",
      "Bioprecipitation",
    ...
    correctIndex: 1,
    explanation: "Bioleaching uses acidophilic bacteria like Acidithiobacillus ferrooxidans to oxidize sulfide ores, releasing trapped metals (copper, gold, uranium). This eco-friendlier alternative to smelting now recovers ~15% of global copper."
  },
  {
    id: "bta10",
    topic: "biotech-applications",
    question: "mRNA vaccines for COVID-19 work by introducing mRNA that encodes:",
    options: [
    ...
    correctIndex: 2,
    explanation: "COVID-19 mRNA vaccines (Pfizer-BioNTech, Moderna) deliver lipid nanoparticle-encapsulated mRNA encoding the viral spike protein. Host cells translate this mRNA, producing spike protein that trains the immune system to recognize and fight the virus."
  }
];
const EXPLANATIONS = [
  {
    id: "overview",
    heading: "Biotechnology Applications: Transforming Every Sector of Human Life",
...
Beyond these first-generation trait modifications, agricultural biotechnology is producing crops with enhanced nutritional profiles, improved stress tolerance, and reduced allergenicity. Golden Rice — engineered to produce β-carotene in the grain endosperm — targets Vitamin A deficiency, which the WHO estimates causes preventable blindness in up to half a million children annually. Drought-tolerant maize varieties (developed using both conventional breeding assisted by molecular markers and transgenic approaches) are being deployed across sub-Saharan Africa. Disease-resistant crops, including GM papaya varieties that saved Hawaii's papaya industry from the ringspot virus in the 1990s, demonstrate biotechnology's ability to solve problems that conventional breeding cannot. The ongoing debate around GM crops centers not on scientific consensus about safety but on governance, intellectual property, and socioeconomic equity.`
  ...
  {
    id: "industrial",
    heading: "Industrial Biotechnology: Bio-Based Manufacturing for a Sustainable Future",
...
Biofuels represent one of industrial biotechnology's largest markets. First-generation bioethanol (from corn starch or sugarcane sucrose) and biodiesel (from vegetable oils or algae lipids) are now blended into transportation fuels globally. Second-generation cellulosic biofuels go further, using engineered cellulases and hemicellulases to unlock the energy stored in agricultural residues (corn stover, wheat straw) that would otherwise be burned or left in fields. Engineered microorganisms — bacteria, yeast, and algae — are being developed to produce jet fuel, plastics precursors, and specialty chemicals directly from CO₂ or agricultural waste. Bioplastics, particularly polyhydroxyalkanoates (PHAs) produced by bacterial fermentation, offer a biodegradable alternative to petroleum-derived plastics, a critical development as plastic pollution reaches every corner of the biosphere.`
  ...
  {
    id: "environment",
    heading: "Environmental Biotechnology: Biology as a Tool for Ecological Restoration",
...
Modern wastewater treatment plants are sophisticated biological systems. Activated sludge bioreactors use diverse microbial communities to remove organic matter, nitrogen (via nitrification and denitrification), and phosphorus from municipal and industrial wastewater. Anaerobic digestion converts organic waste into biogas (methane and CO₂), providing both pollution control and renewable energy. Looking further into the future, synthetic biology is enabling designer organisms: bacteria with inducible reporter genes that glow in the presence of specific heavy metals, serving as biosensors for environmental monitoring; engineered algae that absorb excess phosphorus from agricultural runoff; and enzymes like PETase, discovered in Ideonella sakaiensis and now dramatically improved by directed evolution, that break down PET plastic into reusable monomers — offering a biological path to solving the global plastic crisis.`
  ...
  {
    id: "future",
    heading: "The Future of Biotechnology Applications: Challenges and Prospects",
...
function BiotechApplicationsSection() {
  const [expandedId, setExpandedId] = reactExports.useState("medicine");
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              ...
              children: "🔬 Application Categories"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mb-6", children: [
            "Click a category to explore specific examples and real-world applications. Use",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "kbd",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "ul",
            {
              ...
              children: CATEGORIES.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                AppCard,
                {
                  category: cat,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          StaggerContainer,
          {
            ...
            staggerDelay: 0.09,
            children: EXPLANATIONS.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "10 questions covering recombinant proteins, GM crops, bioremediation, gene therapy, biofuels, and more." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            QuizEngine,
            {
              topicId: "biotech-applications",
...
export {
  BiotechApplicationsSection as default
};
