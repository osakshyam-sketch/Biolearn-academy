...
const SAMPLE_BANDS = [
  ...
  { lane: 1, label: "~4 kb", size: 4e3, yPercent: 33, color: TEAL, width: 44 },
  {
    lane: 1,
    label: "~900 bp",
    size: 900,
  ...
  { lane: 2, label: "~6 kb", size: 6e3, yPercent: 24, color: TEAL, width: 44 },
  { lane: 2, label: "~2 kb", size: 2e3, yPercent: 47, color: TEAL, width: 44 },
  {
    lane: 2,
    label: "~500 bp",
    size: 500,
...
const ARROW_DELAYS = [0, 0.2, 0.4, 0.6, 0.8, 1];
function GelDiagram() {
  const [running, setRunning] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(0);
  const [done, setDone] = reactExports.useState(false);
  const [uvMode, setUvMode] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: running ? "rgba(0,200,160,0.15)" : "oklch(0.72 0.19 185 / 0.25)",
                color: TEAL,
                border: `1.5px solid ${running ? "oklch(0.72 0.19 185 / 0.5)" : "oklch(0.72 0.19 185)"}`,
                boxShadow: running ? "none" : "0 0 16px oklch(0.72 0.19 185 / 0.35)",
                outlineColor: TEAL
              },
              children: running ? "⚡ Running…" : "▶ Run Gel"
            }
          ),
            ...
            "button",
            {
              ...
              "aria-label": uvMode ? "Switch to white light view" : "Switch to UV light — shows ethidium bromide fluorescence",
              ...
              style: {
                background: uvMode ? "oklch(0.78 0.20 70 / 0.25)" : "rgba(255,200,60,0.1)",
                color: uvMode ? AMBER : "oklch(0.75 0.14 70)",
                border: `1.5px solid ${uvMode ? AMBER : "oklch(0.75 0.14 70 / 0.5)"}`,
                outlineColor: AMBER
              },
              children: uvMode ? "🔆 White Light" : "🔵 UV Stain"
            }
          ),
          (done || progress > 0) && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: resetRun,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: uvMode ? "0 0 40px oklch(0.72 0.19 185 / 0.35), 0 0 80px oklch(0.72 0.19 185 / 0.15)" : "0 4px 32px rgba(0,0,0,0.6)"
            },
            "aria-live": "polite",
            "aria-atomic": "false",
            children: [
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: "⊖ Negative (cathode) — DNA loads here"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    ...
                    width: GEL_W,
                    height: GEL_H,
                    background: uvMode ? "linear-gradient(180deg, #05081a 0%, #070c1e 100%)" : `linear-gradient(180deg, ${gelBg} 0%, #0c1548 100%)`,
                  ...
                  children: [
                    DIVIDER_IDS.map((divId, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                    ...
                    ALL_BANDS.map((band) => {
                      ...
                      const bandColor = uvMode ? band.isLadder ? "oklch(0.85 0.20 210)" : band.lane === 3 ? "oklch(0.88 0.22 70)" : "oklch(0.80 0.22 155)" : band.color;
                      const glow = uvMode ? `0 0 12px ${bandColor}, 0 0 24px ${bandColor}88` : `0 0 8px ${band.color}99`;
                      return /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          className: "absolute",
                          style: {
                            ...
                            transition: "opacity 0.3s ease, background 0.5s ease, box-shadow 0.5s ease"
                          },
                          "aria-label": `${LANE_LABELS[band.lane]} band at ${band.label}`
                        },
                        `band-lane${band.lane}-${band.label}`
                      );
                    }),
                    done && LADDER_BANDS.map((band) => {
                    ...
                    running && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        "aria-hidden": "true",
                        children: ARROW_IDS.map((arrowId, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            style: {
                              fontSize: 14,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: LANE_LABELS.map((lbl, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
          ...
          "section",
          {
            ...
            children: [
              ...
              ].map(({ label, desc, color }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.78 0.06 220)" }, children: desc })
                  ]
                },
                label
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: "💡 Smaller fragments travel farther from the wells. Compare unknown bands to the DNA ladder to estimate size."
                }
              )
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "aria-live": "polite",
            children: [
              !running && progress === 0 && "Press ▶ Run Gel to apply electric current and watch DNA fragments separate by size",
              running && `⚡ Applying 100V DC — DNA fragments migrating toward positive electrode… ${Math.round(progress * 100)}%`,
              done && !uvMode && "✅ Migration complete — click UV Stain to visualize ethidium bromide fluorescence",
              done && uvMode && "🔵 UV mode: ethidium bromide intercalated in DNA glows orange under UV light"
            ]
          }
        )
      ]
...
const GEL_QUIZ = [
  {
    ...
    correctIndex: 1,
    explanation: "Gel electrophoresis separates molecules based on their size and charge by driving them through a gel matrix with an electric field. Smaller fragments move faster and travel farther; larger fragments are impeded and stay near the wells.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-2",
    question: "Why do smaller DNA fragments migrate farther in a gel during electrophoresis?",
    options: [
    ...
    correctIndex: 2,
    explanation: "The agarose gel acts as a molecular sieve. Smaller fragments weave through the tangled network of pores much more easily than larger fragments, which are significantly impeded by the gel matrix. This size-dependent friction is the basis of separation.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-3",
    question: "What is a DNA ladder (molecular weight marker) used for in gel electrophoresis?",
    options: [
    ...
    correctIndex: 2,
    explanation: "A DNA ladder contains a set of DNA fragments of precisely known sizes run in one lane of the gel. After electrophoresis, each ladder band appears at a predictable position based on its size. Researchers compare the migration distance of unknown bands to the ladder to estimate their sizes.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-4",
    question: "What polymer forms the matrix of the most common nucleic acid electrophoresis gel?",
    options: ["Polyacrylamide", "Cellulose", "Agarose", "Gelatin"],
    correctIndex: 2,
    explanation: "Agarose, a polysaccharide derived from red seaweed, is the standard matrix for separating DNA and RNA fragments by size. It forms a tangled three-dimensional network of pores when cooled. Polyacrylamide gels are used for higher-resolution separation of proteins and small nucleic acids.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-5",
    question: "In gel electrophoresis, toward which electrode do DNA fragments migrate, and why?",
    options: [
    ...
    correctIndex: 1,
    explanation: "DNA molecules carry an overall negative charge at physiological pH because of the multiple phosphate groups in the sugar-phosphate backbone. In an electric field, negatively charged molecules are attracted to the positive electrode (anode) and migrate toward it.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-6",
    question: "Which dye is classically used to visualize DNA bands in an agarose gel under UV light?",
    options: [
    ...
    correctIndex: 3,
    explanation: "Ethidium bromide (EtBr) intercalates between the base pairs of double-stranded DNA and fluoresces bright orange when exposed to UV light, making DNA bands visible. While highly effective, EtBr is a mutagen and many labs now use safer alternatives like SYBR Safe or GelRed.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-7",
    question: "What technique uses gel electrophoresis as its first step to identify specific DNA sequences on a membrane?",
    options: [
    ...
    correctIndex: 2,
    explanation: "Southern blotting (developed by Edwin Southern in 1975) starts with gel electrophoresis to separate DNA fragments by size, then transfers them to a membrane and uses a labeled probe to detect specific sequences. It is used for gene copy number analysis, transgene confirmation, and genetic disease diagnosis.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-8",
    question: "How does gel electrophoresis contribute to DNA fingerprinting used in forensic science?",
    options: [
    ...
    correctIndex: 1,
    explanation: "In DNA fingerprinting (profiling), specific short tandem repeat (STR) regions are first amplified by PCR, then separated by gel electrophoresis. The resulting pattern of band sizes is unique to each individual (except identical twins) and can match suspects to biological evidence.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-9",
    question: "What is the role of the loading dye added to DNA samples before gel electrophoresis?",
    options: [
    ...
    correctIndex: 1,
    explanation: "Loading dye contains two components: a dense substance (glycerol or ficoll) that weighs down the sample so it sinks into the well rather than floating out, and tracking dyes (bromophenol blue, xylene cyanol) that migrate at known rates and are visible during the run so the researcher can monitor progress.",
    topic: "gel-electrophoresis"
  },
  {
    id: "gel-10",
    question: "How does increasing the agarose concentration of a gel affect the separation of DNA fragments?",
    options: [
...
function GelElectrophoresisSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-4 py-16 sm:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "gel-section-heading", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SectionHeader,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 pt-6 pb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, color: "oklch(0.55 0.08 220)" }, children: "Ethidium bromide visualization included" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h3",
                  {
                    ...
                    style: { color: TEAL },
                    children: "DNA Migration Simulator"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "p",
                  {
                    ...
                    children: [
                      "Click ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: TEAL }, children: "Run Gel" }),
                      " to apply 100V and watch fragments separate by size. Then activate",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: AMBER }, children: "UV Stain" }),
                      " to see ethidium bromide fluorescence."
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 pb-8 flex justify-center overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GelDiagram, {}) })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerContainer, { className: "mb-14 flex flex-col gap-8", children: EXPLANATIONS.map((para, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "rounded-xl p-6",
            style: {
              background: i % 2 === 0 ? "oklch(0.11 0.05 240)" : "oklch(0.13 0.06 250)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 22, lineHeight: 1 }, children: icon }),
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "10 questions covering gel electrophoresis principles and applications"
                      }
                    )
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: "oklch(0.11 0.05 240)" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(QuizEngine, { questions: GEL_QUIZ, topicId: "gel-electrophoresis" }) })
            ]
          }
        ) })
      ] })
...
export {
  GelElectrophoresisSection as default
};
