import { c as createLucideIcon, j as jsxRuntimeExports, m as motion, r as reactExports, R as React, T as TOPICS, A as AnimatePresence } from "./index-V1Xys_hZ.js";
/**
...
function QuizEngine({ topicId, questions }) {
  ...
  const questionId = reactExports.useId();
  const feedbackId = reactExports.useId();
  const scoreId = reactExports.useId();
  const firstOptionRef = reactExports.useRef(null);
  ...
  reactExports.useEffect(() => {
    if (phase === "quiz" && !showFeedback) {
      const timer = setTimeout(() => {
        var _a;
        (_a = firstOptionRef.current) == null ? void 0 : _a.focus();
      }, 400);
  ...
  const resultLabel = percentage >= 80 ? "Excellent!" : percentage >= 60 ? "Good work!" : "Keep learning!";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: `font-display text-xl font-bold ${topic.accentClass}`, children: "Knowledge Quiz" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              "aria-live": "polite",
              "aria-atomic": "true",
              children: phase === "quiz" ? `Question ${currentIndex + 1} of ${questions.length}` : `Score: ${score} out of ${questions.length}`
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: phase === "quiz" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 rounded-full bg-muted", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "fieldset",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: "sr-only", children: current.question }),
                    current.options.map((option, idx) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.button,
                        {
                          ref: isFirstOption ? firstOptionRef : void 0,
                          type: "button",
                          ...
                          disabled: showFeedback && idx !== current.correctIndex && idx !== selected,
                          ...
                          children: [
                            ...
                            showFeedback && idx === current.correctIndex && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                CircleCheckBig,
                                {
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Correct" })
                            ] }),
                            showFeedback && idx === selected && idx !== current.correctIndex && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                CircleX,
                                {
                                  className: "h-4 w-4 shrink-0",
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sr-only", children: "Incorrect" })
                            ] })
                          ]
                        },
                        `opt-${option.slice(0, 20)}`
                      );
                    })
                  ]
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  "aria-atomic": "true",
                  className: "sr-only",
                  children: showFeedback ? selected === current.correctIndex ? `Correct! ${current.explanation}` : `Incorrect. The correct answer is ${current.options[current.correctIndex]}. ${current.explanation}` : ""
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showFeedback && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start gap-2 mb-2", children: selected === current.correctIndex ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        CircleCheckBig,
                        {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  "aria-atomic": "true",
                  className: "sr-only",
                  children: `Quiz complete. ${resultLabel} You scored ${score} out of ${questions.length}, ${percentage} percent correct.`
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  "aria-hidden": "true",
                  children: percentage >= 80 ? "🏆" : percentage >= 60 ? "🎯" : "📚"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-1 text-xl font-semibold text-foreground", children: resultLabel }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-muted-foreground max-w-2xl leading-relaxed", children: subtitle }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            className: "h-1 rounded-full",
            style: {
              background: topic.color === "biomolecule" ? "var(--gradient-biomolecule)" : topic.color === "cell" ? "var(--gradient-cell)" : topic.color === "dna" ? "var(--gradient-dna)" : topic.color === "biotech" ? "linear-gradient(135deg, oklch(0.72 0.18 172) 0%, oklch(0.85 0.12 172) 100%)" : "var(--gradient-protein)"
            },
            initial: { width: 0 },
...
export {
  AnimatedEntrance as A,
  QuizEngine as Q,
  SectionHeader as S,
  StaggerContainer as a,
  StaggerItem as b
};
