import { j as jsxRuntimeExports, r as reactExports, m as motion } from "./index-V1Xys_hZ.js";
...
function Base({ base, idx, showMatch, matched }) {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: isMatch ? "0 0 10px oklch(0.72 0.20 142 / 0.6)" : isMismatch ? "0 0 10px oklch(0.72 0.18 27 / 0.6)" : "none"
          },
...
function SequenceAlignmentDemo() {
  const [aligned, setAligned] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 mb-1", "aria-label": "Base color legend", children: [
          Object.entries(BASE_COLORS).filter(([k]) => k !== "-").map(([base, c]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: c.text }, children: c.label })
          ] }, base)),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.72 0.20 142)" }, children: "Match" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "oklch(0.72 0.18 27)" }, children: "Mismatch" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap", children: SEQ1.split("").map((base, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Base,
                {
                  base,
                  idx: i,
        ...
        aligned && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: matches.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "section",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1.5 flex-wrap", children: SEQ2.split("").map((base, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Base,
                {
                  base,
                  idx: i,
        ...
        aligned && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full overflow-hidden bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    className: "h-full rounded-full",
                    style: {
                      background: "linear-gradient(90deg, oklch(0.60 0.18 220), oklch(0.72 0.20 142))"
                    },
                    initial: { width: 0 },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: animating ? "Aligning…" : "▶ Align Sequences"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.70 0.16 220)" }, children: "How it works:" }),
          " ",
          "Global alignment (Needleman-Wunsch) compares every position. Green glow = match, red glow = mismatch. The similarity score quantifies how related two sequences are — key to identifying homologous genes across species."
        ] })
      ]
    }
  );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h4",
          {
            ...
            style: { color: "oklch(0.70 0.16 220)" },
            children: "🌳 Phylogenetic Tree — Evolutionary Relationships"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            "aria-hidden": "true",
            children: [
              TREE_BRANCHES.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.line,
                {
                  x1: b.x1,
                  y1: b.y1,
                ...
                `branch-${b.x1}-${b.y1}-${b.x2}-${b.y2}`
              )),
              TREE_SPECIES.map((sp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.circle,
                  {
                    cx: sp.x,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.text,
                  {
                    ...
                    children: sp.id === "zebrafish" ? "ZF" : sp.label.slice(0, 2).toUpperCase()
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.text,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.text,
                {
                  ...
                  children: "Common ancestor"
                }
              )
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-3", children: "Branching points (nodes) represent common ancestors. Shorter branches between species = greater evolutionary similarity. Human and Chimpanzee share ~98.7% of their DNA sequence." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mt-3", children: TREE_SPECIES.map((sp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
...
const BIOINFORMATICS_QUIZ = [
  {
    ...
    correctIndex: 1,
    explanation: "Bioinformatics applies computational, mathematical, and statistical methods to collect, store, analyze, and interpret biological data — especially the massive sequence datasets generated by modern genomics and proteomics technologies."
  },
  {
    id: "bio2",
    topic: "bioinformatics",
    ...
    correctIndex: 1,
    explanation: "BLAST (Basic Local Alignment Search Tool) rapidly searches databases like GenBank or UniProt to find sequences similar to a query sequence. It is the most widely used bioinformatics tool, enabling researchers to infer function and evolutionary relationships."
  },
  {
    id: "bio3",
    topic: "bioinformatics",
    ...
    correctIndex: 2,
    explanation: "GenBank, maintained by NCBI, is the primary public repository for nucleotide sequences. It contains over 250 million sequences from hundreds of thousands of organisms, all freely accessible to researchers worldwide."
  },
  {
    id: "bio4",
    topic: "bioinformatics",
    question: "What is the difference between local and global sequence alignment?",
    options: [
    ...
    correctIndex: 1,
    explanation: "Local alignment (Smith-Waterman) finds the most similar sub-region between two sequences — useful for finding conserved domains in divergent proteins. Global alignment (Needleman-Wunsch) aligns entire sequences end-to-end, best for closely related sequences of similar length."
  },
  {
    id: "bio5",
    topic: "bioinformatics",
    question: "In a phylogenetic tree, what do the branch lengths typically represent?",
    options: [
    ...
    correctIndex: 2,
    explanation: "In most phylogenetic trees, branch lengths represent the amount of evolutionary change (sequence divergence) between nodes. Longer branches indicate more mutations occurred, which often (but not always) correlates with more time elapsed since divergence."
  },
  {
    id: "bio6",
    topic: "bioinformatics",
    question: "What revolutionary AI tool was released in 2020 to predict protein structures?",
    options: ["ProteinBERT", "AlphaFold2", "DeepGenome", "RosettaNet"],
    correctIndex: 1,
    explanation: "AlphaFold2, developed by DeepMind, achieved near-experimental accuracy in protein structure prediction at the 2020 CASP14 competition. It has since predicted structures for over 200 million proteins, transforming structural biology and drug discovery."
  },
  {
    id: "bio7",
    topic: "bioinformatics",
    ...
    correctIndex: 2,
    explanation: "A genome is the complete set of DNA in an organism, including all its genes and non-coding sequences. The human genome contains approximately 3 billion base pairs across 23 pairs of chromosomes and encodes about 20,000 protein-coding genes."
  },
  {
    id: "bio8",
    topic: "bioinformatics",
    ...
    correctIndex: 1,
    explanation: "Bioinformatics enables computational identification of drug targets (via genomic analysis of disease) and candidate molecules (via docking simulations) before expensive laboratory synthesis and testing. This dramatically accelerates and reduces the cost of drug discovery pipelines."
  },
  {
    id: "bio9",
    topic: "bioinformatics",
    ...
    correctIndex: 2,
    explanation: "Metagenomics sequences all DNA from an environmental sample (gut, soil, ocean) without isolating individual organisms. This reveals microbial communities that cannot be cultured — and has shown that the human gut microbiome contains trillions of organisms from thousands of species with profound effects on health."
  },
  {
    id: "bio10",
    topic: "bioinformatics",
    question: "Which database stores the three-dimensional structures of proteins?",
    options: ["GenBank", "UniProt", "KEGG", "Protein Data Bank (PDB)"],
    correctIndex: 3,
    explanation: "The Protein Data Bank (PDB) archives experimentally determined 3D structures of proteins, nucleic acids, and complex assemblies, solved by X-ray crystallography, cryo-electron microscopy, and NMR spectroscopy. It currently houses over 230,000 structures."
  }
];
function BioinformaticsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              ...
              style: { color: "oklch(0.70 0.16 220)" },
              children: "💻 Interactive Sequence Alignment Demo"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SequenceAlignmentDemo, {})
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "left", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhylogeneticTree, {}) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.05, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              ...
              style: { color: "oklch(0.70 0.16 220)" },
              children: "🛠️ Key Tools & Resources"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StaggerContainer,
            {
              ...
              staggerDelay: 0.1,
              children: CONCEPT_CARDS.map((card) => /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", "aria-hidden": "true", children: card.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "h4",
                        {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: card.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex flex-col gap-0.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground leading-snug", children: item.desc })
                    ] }, item.name)) })
                  ]
                }
              ) }, card.title))
            ...
            children: EXPLANATIONS.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsx(StaggerItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  section.body.split("\n\n").map((paragraph, pi) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedEntrance, { direction: "up", delay: 0.1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              ...
              style: { color: "oklch(0.70 0.16 220)" },
              children: "💻 Test Your Bioinformatics Knowledge"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "10 questions covering databases, sequence alignment, phylogenetics, AlphaFold, genomics, and career pathways." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            QuizEngine,
            {
              topicId: "bioinformatics",
...
export {
  BioinformaticsSection as default
};
