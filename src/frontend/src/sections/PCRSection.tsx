...
// ── accent colour for PCR (teal/cyan) ─────────────────────────────────────────
...
// Individual base-pair row for the DNA illustration
function BasePairRow({
  ...
  // Colour the newly-synthesised extension segment teal/green
  ...
  return (
    <g>
      {/* Left (template) strand backbone segment */}
      <line
        x1={LEFT_X}
        y1={y}
        x2={lx}
      ...
      />
      {/* Right (template) strand backbone segment */}
      <line
        x1={rx}
        y1={y}
        x2={RIGHT_X}
        ...
        style={{ transition: "all 0.5s ease" }}
      />
      {/* Hydrogen bond — only visible when strands are together in extension */}
      {phase === "extension" && (
        <line
          x1={lx}
          y1={y}
...
function PCRDiagram() {
  ...
  // Primer rows (3 rows at middle)
  const primerRows = [70, 90, 110];

  // Copy count label (log2 approximation: 2^cycle)
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs" style={{ color: "oklch(0.72 0.18 142)" }}>
          ≈ {copies} copies
        </span>
        <span
      ...
      <div className="flex flex-col md:flex-row gap-5 items-start">
        ...
        >
          {/* Background track lines for backbone */}
          <line
            x1="70"
            y1="20"
            x2="70"
            ...
            <>
              <defs>
                <marker
                  ...
                  orient="auto"
                >
                  <path d="M0,0 L0,6 L6,3 z" fill="oklch(0.72 0.18 142)" />
                </marker>
                <marker
                  id="arrowTeal"
                  markerWidth="6"
...
const PCR_QUIZ: QuizQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation:
      "PCR stands for Polymerase Chain Reaction. It uses a DNA polymerase enzyme to repeatedly copy a specific DNA segment in a chain-like, exponential fashion.",
  },
  {
    id: "pcr2",
    topic: "pcr",
    ...
    correctIndex: 3,
    explanation:
      "Denaturation occurs at 94–96 °C (usually 95 °C). This high temperature breaks the hydrogen bonds between the two complementary DNA strands, separating them into single strands for use as templates.",
  },
  {
    id: "pcr3",
    topic: "pcr",
    ...
    correctIndex: 1,
    explanation:
      "During the annealing step (55–65 °C), the temperature is lowered to allow short DNA primers to bind to their complementary sequences on the separated single-stranded templates.",
  },
  {
    id: "pcr4",
    topic: "pcr",
    question:
      "Why is Taq polymerase preferred over other DNA polymerases in PCR?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Taq polymerase is isolated from Thermus aquaticus, a bacterium from hot springs. It is thermostable — it remains active after repeated exposure to 95 °C, making it ideal for PCR's repeated heat cycles.",
  },
  {
    id: "pcr5",
    topic: "pcr",
    ...
    correctIndex: 2,
    explanation:
      "Primers are short (~20 nt) single-stranded DNA sequences complementary to the flanking regions of the target DNA. They define exactly where polymerase starts copying, and thus which region of the genome is amplified.",
  },
  {
    id: "pcr6",
    topic: "pcr",
    ...
    correctIndex: 2,
    explanation:
      "PCR amplification is exponential. Each cycle doubles the number of DNA copies, so after n cycles there are theoretically 2ⁿ copies. After 30 cycles, a single molecule yields over one billion copies.",
  },
  {
    id: "pcr7",
    topic: "pcr",
    ...
    correctIndex: 2,
    explanation:
      "Extension occurs at 72 °C because that is the optimum temperature for Taq polymerase. At this temperature the enzyme synthesises new DNA at ~1000 bases per minute, extending from the primer along the template.",
  },
  {
    id: "pcr8",
    topic: "pcr",
    ...
    correctIndex: 2,
    explanation:
      "qPCR (quantitative PCR) uses fluorescent reporters to monitor PCR amplification cycle by cycle, allowing precise quantification of the starting amount of DNA or RNA in a sample.",
  },
  {
    id: "pcr9",
    topic: "pcr",
    question:
      "Which of these is a direct application of PCR in forensic science?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Forensic PCR amplifies specific short tandem repeat (STR) loci from trace DNA samples (hair, skin cells, blood). The resulting profile uniquely identifies individuals with extremely high probability — this is DNA fingerprinting.",
  },
  {
    id: "pcr10",
    topic: "pcr",
    question:
      "What building blocks does Taq polymerase use to synthesise new DNA strands?",
    options: [
    ...
    correctIndex: 2,
    explanation:
      "Taq polymerase uses free deoxyribonucleoside triphosphates (dNTPs — dATP, dTTP, dGTP, dCTP) as building blocks. It adds them one at a time, complementary to the template, releasing pyrophosphate as a by-product.",
  },
];
...
export default function PCRSection() {
  return (
    <section className="px-6 py-16 max-w-5xl mx-auto" data-ocid="pcr-section">
      {/* Header */}
      <SectionHeader
        topicId="pcr"
      ...
      <AnimatedEntrance direction="up" delay={0.1}>
        <div className="mb-4">
          ...
          <p className="text-muted-foreground mb-6">
            10 questions covering PCR steps, temperatures, enzyme roles, and
