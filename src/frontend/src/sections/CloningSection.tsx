...
const C = {
  ...
  geneA: "oklch(0.72 0.22 36)", // orange – target gene
  geneB: "oklch(0.70 0.20 290)", // purple – plasmid backbone
  bacteria: "oklch(0.68 0.19 262)", // blue   – bacterium
  ligase: "oklch(0.72 0.18 142)", // green  – DNA ligase
} as const;
        ...
        <g key={col.uid}>
          <circle
            ...
            style={{
              filter:
                col.hasGene && active
                  ? "drop-shadow(0 0 6px oklch(0.70 0.17 160))"
                  : "none",
              animation:
                col.hasGene && active
        ...
        {STEPS.map((s, idx) => (
          <button
            ...
            style={{
              ...
              boxShadow:
                stepIndex === idx
                  ? "0 0 10px oklch(0.70 0.17 160 / 0.3)"
                  : "none",
            }}
        ...
        >
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(90deg, oklch(0.70 0.17 160), oklch(0.72 0.18 195))",
...
const QUIZ: QuizQuestion[] = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Recombinant DNA is produced by combining DNA segments from two or more sources — for example, inserting a human gene into a bacterial plasmid.",
    topic: "cloning",
  },
  {
    id: "cloning-q2",
    ...
    correctIndex: 2,
    explanation:
      "Restriction enzymes act as molecular scissors, recognizing and cutting specific short DNA sequences, often producing sticky ends that facilitate joining.",
    topic: "cloning",
  },
  {
    id: "cloning-q3",
    ...
    correctIndex: 1,
    explanation:
      "Sticky ends are short single-stranded nucleotide overhangs produced by staggered restriction enzyme cuts. They are complementary and facilitate joining.",
    topic: "cloning",
  },
  {
    id: "cloning-q4",
    ...
    correctIndex: 1,
    explanation:
      "A plasmid is a small, circular, self-replicating DNA molecule. Engineered plasmid vectors carry the foreign gene of interest into host cells.",
    topic: "cloning",
  },
  {
    id: "cloning-q5",
    ...
    correctIndex: 2,
    explanation:
      "DNA ligase catalyzes phosphodiester bond formation between compatible sticky ends, permanently joining the target gene to the plasmid backbone.",
    topic: "cloning",
  },
  {
    id: "cloning-q6",
    ...
    correctIndex: 1,
    explanation:
      "Transformation is the uptake of foreign DNA by a bacterial cell, usually via heat shock or electroporation, after which the bacteria replicate the gene.",
    topic: "cloning",
  },
  {
    id: "cloning-q7",
    ...
    correctIndex: 1,
    explanation:
      "Selectable markers — usually antibiotic resistance genes — allow scientists to identify transformed bacteria; only colonies with the plasmid survive on antibiotic plates.",
    topic: "cloning",
  },
  {
    id: "cloning-q8",
    ...
    correctIndex: 3,
    explanation:
      "Bacterial cloning vectors require an origin of replication, a selectable marker, and a multiple cloning site. Centromeres are chromosomal features not needed in plasmids.",
    topic: "cloning",
  },
  {
    id: "cloning-q9",
    question:
      "Which commercial product is made using recombinant DNA technology?",
    options: [
      "Table salt (NaCl)",
      "Plastic polymers",
    ...
    correctIndex: 2,
    explanation:
      "Human insulin was the first recombinant protein drug approved (1982). The human insulin gene was cloned into E. coli for industrial-scale production.",
    topic: "cloning",
  },
  {
    id: "cloning-q10",
    question:
      "How does reproductive organism cloning differ from gene cloning?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Gene cloning amplifies a specific DNA sequence. Reproductive cloning (SCNT) creates a new organism genetically identical to the donor — exemplified by Dolly the sheep (1996).",
    topic: "cloning",
  },
];
      ...
      <div className="mx-auto max-w-5xl">
          ...
          <AnimatedEntrance direction="right" delay={0.15}>
            <div className="space-y-5">
              <p className="text-base leading-relaxed text-foreground">
                ...
                is any DNA molecule assembled by joining genetic material from
                two or more different sources. This technology, pioneered in the
                early 1970s by Paul Berg, Stanley Cohen, and Herbert Boyer,
                underpins virtually all of modern biotechnology. By splicing a
                gene of interest from one organism into a carrier DNA molecule,
                scientists can instruct bacteria, yeast, or mammalian cells to
                manufacture virtually any protein.
              </p>
              <p className="text-base leading-relaxed text-foreground">
                The first step is to cut both the donor DNA and a{" "}
                <span className="font-semibold" style={{ color: C.geneB }}>
                  plasmid vector
                </span>{" "}
                with the same{" "}
                <span className="font-semibold" style={{ color: C.teal }}>
                ...
                — a molecular scissors that recognizes a short palindromic
                sequence (e.g., GAATTC for EcoRI) and cuts both strands at that
                site. Staggered cuts leave short unpaired nucleotide overhangs
                called <em>sticky ends</em>, which are complementary to the
                corresponding ends of the target gene fragment, making
                re-annealing spontaneous.
              </p>
              <p className="text-base leading-relaxed text-foreground">
                <span className="font-semibold" style={{ color: C.ligase }}>
                  DNA ligase
                </span>{" "}
                then covalently seals the nick between the two fragments. In the
                cell, ligase normally repairs single-strand breaks; in the
                laboratory it fuses the target gene into the plasmid backbone,
                forming a complete circular <em>recombinant plasmid</em>. This
                newly engineered plasmid is the vehicle that carries the foreign
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {KEY_CONCEPTS.map((kc) => (
                ...
                >
                  ...
                  <dd className="text-sm leading-relaxed text-foreground opacity-85">
                    {kc.def}
                  </dd>
                </div>
              ))}
        ...
        <AnimatedEntrance direction="up" delay={0.15}>
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.70 0.17 160 / 0.18), oklch(0.72 0.18 195 / 0.12))",
              border: borderTeal,
            }}
          >
            <div className="rounded-xl p-6" style={{ background: C.bgDark }}>
              <h3
              ...
              >
                10 questions on recombinant DNA, restriction enzymes, plasmids,
                and applications.
              </p>
